...
from repository import delete_profile_cache, get_profile, get_redis_client, update_profile_name
...
def create_app() -> FastAPI:
    app = FastAPI(title="BFL-0006 Fixed")
    ...
    def update_profile(
        ...
        delete_profile_cache(redis_client, current_user_id)
        return profile
